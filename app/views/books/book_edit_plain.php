...
<body>
    <div>
        <p>
            <a href="/WA-2026-SARA-KRISTANOVA/public/index.php">&larr; Zpět na seznam knih</a>
        </p>
        ...
        <div>
            <form action="/WA-2026-SARA-KRISTANOVA/public/index.php?url=book/update/<?= htmlspecialchars($book['id']) ?>" method="post" enctype="multipart/form-data">
                <div>
                    <div>
